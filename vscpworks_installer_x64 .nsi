...
OutFile vscpworks-${PRODUCT_VERSION}-x64.exe
...
;    !define MUI_FINISHPAGE_RUN "$INSTDIR\vscpworks.exe"
    !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme_vscpworks.txt"
...
Section "Start Menu Shortcut" SEC02
	...
	CreateDirectory "$SMPROGRAMS\vscpworks"
	CreateShortCut "$SMPROGRAMS\VSCP & Friends\readme_vscpworks.lnk" "$INSTDIR\readme_vscpworks.txt" ""
