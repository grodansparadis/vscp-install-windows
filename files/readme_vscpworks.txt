...
VSCP Works Version 13.0.0.4 - Aluminium
=======================================
Copyright (C) 2000-2018 Grodans Paradis AB / /Paradise of the Frog AB.
http://www.paradiseofthefrog.com, info@paradiseofthefrog.com

This is the 13.0.0 - Aluminium  release of VSCP Works (part of (VSCP & Friends). 

  * 2018-02-12 - Fix segfault when closing session window.


        Manual? http://www.vscp.org/docs/vscpworks/doku.php?id=start
